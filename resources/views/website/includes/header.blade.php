            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-3">
                    <div class="categories_wrap">
                        <button type="button" data-bs-toggle="collapse" data-bs-target="#navCatContent" aria-expanded="false" class="categories_btn" onclick="myMenu()">
                            <i class="linearicons-menu"></i><span>All Categories</span>
                        </button>
                        <div id="navCatContent" class="nav_cat navbar nav collapse mb-30" style="display: none;">
                            <ul>
                                @foreach($categories as $category)
                                <li class="dropdown dropdown-mega-menu">
                                    <a class="dropdown-item nav-link dropdown-toggler" href="{{route('product-category',['id' => $category->id])}}" data-bs-toggle="dropdown">
                                        <i class="flaticon-sunglasses"></i> <span>{{$category->name}}</span>
                                    </a>
                                               ...
                                               @if(count($category->subCategories) > 0)
                                                <ul>
                                                    @foreach($category->subCategories as $subCategory)
                                                     <li>
                                                         <a class="dropdown-item nav-link nav_item" href="shop-load-more.html">{{$subCategory->name}}</a>
                                                     </li>
                                                    @endforeach
                                                </ul>
                                               @endif
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul>
                                           ...
                                           <li><a class="dropdown-item nav-link nav_item" href="{{route('contact')}}">Contact</a></li>
...
<script>
  function myMenu() {
     var slideNav = document.getElementById("navCatContent");
     if(slideNav.style.display === "none"){
...
<script>
/*
    var navCatContent = document.getElementById("navCatContent");
 //   navCatContent.style.display="none";
    var MenuBtn = document.getElementById("MenuBtn");
    MenuBtn.addEventListener("mouseover",function(){
        if(navCatContent.style.display="none"){
            navCatContent.style.display="block";
        }else if(navCatContent.style.display="block"){
              navCatContent.style.display="none";
        }
