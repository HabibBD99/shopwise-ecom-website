            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb justify-content-md-end">
                        ...
                        <li class="breadcrumb-item active">Shop All Product</li>
                    </ol>
                </div>
            </div>
        </div><!-- END CONTAINER-->
                        ...
                        <div class="row shop_container loadmore" data-item="8" data-item-show="4" data-finish-message="No More Item to Show" data-btn="Load More">
                            ...
                            <div class="col-lg-3 col-md-4 col-6 grid_item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="{{asset('/')}}website/shop-product-detail.html">light blue Shirt</a></h6>
                                        <div class="product_price">
                            ...
                            <div class="col-lg-3 col-md-4 col-6 grid_item">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('/')}}website/assets/images/product_img12.jpg" alt="product_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6 grid_item">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('/')}}website/assets/images/product_img13.jpg" alt="product_img13">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6 grid_item">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('/')}}website/assets/images/product_img14.jpg" alt="product_img14">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6 grid_item">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('/')}}website/assets/images/product_img15.jpg" alt="product_img14">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6 grid_item">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('/')}}website/assets/images/product_img9.jpg" alt="product_img12">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
